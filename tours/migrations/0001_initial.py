    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(help_text='Provide a detailed description of the tour or event.')),
                ('activities', ckeditor.fields.RichTextField(help_text='List the activities included in the tour or event.')),
                ...
                ('requirements', ckeditor.fields.RichTextField(help_text='Specify any requirements for participants.')),
                ('rules', ckeditor.fields.RichTextField(help_text='Specify any rules for the tour or event.')),
                ('cancellation_policy', ckeditor.fields.RichTextField(help_text='Describe the cancellation policy for the tour or event.')),
                ...
                ('category', models.ForeignKey(help_text='Select the category for the tour or event.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='tours.category')),
                ('city', models.ForeignKey(help_text='Select the city where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='SiteSetting.city')),
                ('country', models.ForeignKey(help_text='Select the country where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='SiteSetting.country')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(help_text='Select the location city name.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='SiteSetting.city')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(help_text='Select the city where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='SiteSetting.city')),
                ('country', models.ForeignKey(help_text='Select the country where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='SiteSetting.country')),
                ('places', models.ManyToManyField(blank=True, help_text='Select the places for the tour or event.', related_name='%(class)ss', to='tours.place')),
                ('services', models.ManyToManyField(blank=True, help_text='Select the services included in the tour or event.', related_name='%(class)ss', to='tours.service')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='places',
            field=models.ManyToManyField(blank=True, help_text='Select the places for the tour or event.', related_name='%(class)ss', to='tours.place'),
        ),
        migrations.AddField(
            model_name='groupevent',
            name='services',
            field=models.ManyToManyField(blank=True, help_text='Select the services included in the tour or event.', related_name='%(class)ss', to='tours.service'),
        ),
    ]
