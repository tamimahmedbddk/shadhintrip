    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destinations', ckeditor.fields.RichTextField(help_text='List the places or locations planned to be visited during the tour.')),
                ...
                ('max_participants', models.PositiveIntegerField(default=1, help_text='Maximum number of participants allowed for the tour or event.')),
                ...
                ('city', models.ForeignKey(help_text='Select the city where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='tours.city')),
                ('country', models.ForeignKey(help_text='Select the country where the tour or event will take place.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='tours.country')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(help_text='Select the country this city belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='tours.country'),
        ),
    ]
